                        ...
                        <div class="shell">
                            <div class="range range-10 range-md-center range-md-middle range-lg-around">
                                ...
                                <div class="cell-md-3 text-center">
                                    <div class="rd-navbar-brand"><a class="reveal-inline-block" href="index.html"><img src="{{ asset('ui/frontend/images/sbflogo.png') }}" alt="" width="191" height="80"></a></div>
                                </div>
                                <div class="cell-md-3">
                    ...
                    <div class="rd-navbar-nav-wrap">
                        <div class="rd-navbar-mobile-scroll">
                            <div class="rd-navbar-mobile-header-wrap">
                                <div class="rd-navbar-mobile-brand"><a href="index.html"><img src="{{ asset('ui/frontend/images/logo-default-2-144x122-1.png') }}" alt="" srcset="images/logo-default-2-144x122-1.png 2x"></a></div>
                            </div>
                            <ul class="rd-navbar-nav">
                                ...
                                <li class="rd-navbar--has-dropdown rd-navbar-submenu"><a href="course-grid.html">Academic</a>
                                    <ul class="rd-navbar-dropdown rd-navbar-open-right" style="">
                                        <li><a href="course-grid.html">Courses</a></li>
                                        <li><a href="course-details.html">Course Details</a></li>
                                    </ul>
                                </li>
                                <li class="rd-navbar--has-dropdown rd-navbar-submenu"><a href="events.html">Admission</a>
                                    <ul class="rd-navbar-dropdown rd-navbar-open-right" style="">
                                        <li><a href="event-page.html">Admission Information</a></li>
                                    </ul>
                                </li>
                                <li><a href="#">Notice</a>
                                    <!-- <ul class="rd-navbar-dropdown">
